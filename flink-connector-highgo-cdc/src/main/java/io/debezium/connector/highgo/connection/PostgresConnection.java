...
import io.debezium.connector.highgo.PgOid;
...
public class PostgresConnection extends JdbcConnection {
    ...
    public synchronized Connection connection() throws SQLException {
        ...
        if (conn instanceof HikariProxyConnection) {
            // assuming HikariCP use com.highgo.jdbc.jdbc.PgConnection
     ...
     * @param slotName the name of the slot
     * @param pluginName the name of the plugin used for the desired slot
     * @return the {@link io.debezium.connector.highgo.connection.ServerInfo.ReplicationSlot} object
     *     or a {@link io.debezium.connector.highgo.connection.ServerInfo.ReplicationSlot#INVALID}
     ...
     *
     * @return a {@link io.debezium.connector.highgo.connection.ServerInfo} instance, never {@code
     *     null}
     * @throws SQLException if anything fails
     */
    ...
    public TimestampUtils getTimestampUtils() {
        try {
            return ((com.highgo.jdbc.jdbc.PgConnection) this.connection()).getTimestampUtils();
        } catch (SQLException e) {
