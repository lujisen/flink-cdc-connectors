...
import io.debezium.connector.highgo.connection.ReplicationMessage.Operation;
import io.debezium.connector.highgo.connection.ReplicationStream;
import io.debezium.connector.highgo.connection.WalPositionLocator;
...
public class PostgresStreamingChangeEventSource
    ...
    private final io.debezium.connector.highgo.connection.PostgresConnection connection;
    ...
    private io.debezium.connector.highgo.connection.Lsn lastCompletelyProcessedLsn;
    ...
    public void execute(
        ...
        try {
            ...
            if (hasStartLsnStoredInContext) {
                ...
                final io.debezium.connector.highgo.connection.Lsn lsn =
    ...
    private void searchWalPosition(
            ...
            final WalPositionLocator walPosition)
            throws SQLException, InterruptedException {
        AtomicReference<io.debezium.connector.highgo.connection.Lsn> resumeLsn =
                new AtomicReference<>();
        int noMessageIterations = 0;
    ...
    public void commitOffset(Map<String, ?> offset) {
        try {
            ...
            final io.debezium.connector.highgo.connection.Lsn commitLsn =
                    io.debezium.connector.highgo.connection.Lsn.valueOf(
                            (Long) offset.get(PostgresOffsetContext.LAST_COMMIT_LSN_KEY));
            final io.debezium.connector.highgo.connection.Lsn changeLsn =
                    io.debezium.connector.highgo.connection.Lsn.valueOf(
                            (Long)
                                    offset.get(
