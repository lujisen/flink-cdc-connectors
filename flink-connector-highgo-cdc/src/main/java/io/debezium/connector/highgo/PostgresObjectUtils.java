...
public class PostgresObjectUtils {
    ...
    public static PostgresSchema newSchema(
            io.debezium.connector.highgo.connection.PostgresConnection connection,
     ...
     */
    public static io.debezium.connector.highgo.connection.PostgresConnection
                    .PostgresValueConverterBuilder
            newPostgresValueConverterBuilder(PostgresConnectorConfig config) {
        return typeRegistry ->
                PostgresValueConverter.of(config, StandardCharsets.UTF_8, typeRegistry);
    }

    // modified from
    // io.debezium.connector.highgo.PostgresConnectorTask.createReplicationConnection.
    ...
    public static ReplicationConnection createReplicationConnection(
            ...
            io.debezium.connector.highgo.connection.PostgresConnection postgresConnection,
            boolean doSnapshot,
            PostgresConnectorConfig connectorConfig) {
