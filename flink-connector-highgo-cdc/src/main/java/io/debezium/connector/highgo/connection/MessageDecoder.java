...
/**
 * A class that is able to deserialize/decode binary representation of a batch of replication
 * messages generated by logical decoding plugin. Clients provide a callback code for processing.
 *
...
public interface MessageDecoder {
     ...
     */
    ChainedLogicalStreamBuilder optionsWithMetadata(
     ...
     * @return the builder instance
     */
    ChainedLogicalStreamBuilder optionsWithoutMetadata(
            ChainedLogicalStreamBuilder builder,
            Function<Integer, Boolean> hasMinimumServerVersion);
    ...
    /**
     * A callback into the decoder allowing it to decide whether the supplied message should be
     * processed by the decoder or whether it can be skipped.
     *
