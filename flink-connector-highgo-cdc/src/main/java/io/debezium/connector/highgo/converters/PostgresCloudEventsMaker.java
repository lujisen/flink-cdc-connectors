...
public class PostgresCloudEventsMaker extends CloudEventsMaker {
    ...
    public PostgresCloudEventsMaker(
    ...
    public String ceId() {
        return "name:"
                ...
                + recordParser
                        .getMetadata(
                                io.debezium.connector.highgo.converters.PostgresRecordParser
                                        .LSN_KEY)
                        .toString()
                + ";txId:"
                + recordParser.getMetadata(PostgresRecordParser.TXID_KEY).toString();
    }
}
