...
import io.debezium.connector.highgo.connection.*;
import io.debezium.connector.highgo.connection.ReplicationMessage.Column;
import io.debezium.connector.highgo.connection.ReplicationMessage.NoopMessage;
...
public class PgOutputMessageDecoder extends AbstractMessageDecoder {
    ...
    private void handleRelationMessage(ByteBuffer buffer, TypeRegistry typeRegistry)
        ...
        List<io.debezium.connector.highgo.connection.pgoutput.ColumnMetaData> columns =
                new ArrayList<>();
        ...
        for (short i = 0; i < columnCount; ++i) {
            ...
            columns.add(
                    new io.debezium.connector.highgo.connection.pgoutput.ColumnMetaData(
                            columnName,
                            postgresType,
                            key,
                            optional,
        ...
        Table table =
                resolveRelationFromMetadata(
                        new io.debezium.connector.highgo.connection.pgoutput
    ...
    /**
     * Constructs a {@link Table} based on the supplied {@link
     * io.debezium.connector.highgo.connection.pgoutput.PgOutputRelationMetaData}.
     *
