...
public final class Utils {
    ...
    public static io.debezium.connector.highgo.connection.Lsn lastKnownLsn(
            PostgresOffsetContext ctx) {
        return ctx.lsn();
    }

    public static HighgoOffset currentOffset(
            io.debezium.connector.highgo.connection.PostgresConnection jdbcConnection) {
        Long lsn;
        Long txId;
        try {
        ...
        return HighgoOffset.of(offsetMap);
    }
