...
/*import io.debezium.connector.highgo.LegacyV1PostgresSourceInfoStructMaker;
import io.debezium.connector.highgo.LogicalDecodingMessageFilter;
import io.debezium.connector.highgo.Module;
import io.debezium.connector.highgo.PostgresConnector;
import io.debezium.connector.highgo.PostgresSourceInfoStructMaker;*/
import io.debezium.connector.highgo.connection.MessageDecoder;
import io.debezium.connector.highgo.connection.MessageDecoderContext;
...
import io.debezium.connector.highgo.connection.pgoutput.PgOutputMessageDecoder;
import io.debezium.connector.highgo.connection.pgproto.PgProtoMessageDecoder;
import io.debezium.connector.highgo.connection.wal2json.NonStreamingWal2JsonMessageDecoder;
import io.debezium.connector.highgo.connection.wal2json.StreamingWal2JsonMessageDecoder;
import io.debezium.connector.highgo.snapshot.AlwaysSnapshotter;
import io.debezium.connector.highgo.snapshot.InitialOnlySnapshotter;
import io.debezium.connector.highgo.snapshot.InitialSnapshotter;
import io.debezium.connector.highgo.snapshot.NeverSnapshotter;
...
public class PostgresConnectorConfig extends RelationalDatabaseConnectorConfig {
    ...
    protected static final int DEFAULT_PORT = 5_866;
    ...
    private final io.debezium.connector.highgo.LogicalDecodingMessageFilter logicalDecodingMessageFilter;
    ...
    public PostgresConnectorConfig(Configuration config) {
        ...
        this.logicalDecodingMessageFilter = new io.debezium.connector.highgo.LogicalDecodingMessageFilter(config.getString(LOGICAL_DECODING_MESSAGE_PREFIX_INCLUDE_LIST),
    ...
    protected SourceInfoStructMaker<? extends AbstractSourceInfo> getSourceInfoStructMaker(Version version) {
        switch (version) {
            case V1:
                return new LegacyV1PostgresSourceInfoStructMaker(io.debezium.connector.highgo.Module.name(), io.debezium.connector.highgo.Module.version(), this);
            default:
                return new PostgresSourceInfoStructMaker(io.debezium.connector.highgo.Module.name(), io.debezium.connector.highgo.Module.version(), this);
        }
    }
    ...
    public String getContextName() {
        return io.debezium.connector.highgo.Module.contextName();
    }
