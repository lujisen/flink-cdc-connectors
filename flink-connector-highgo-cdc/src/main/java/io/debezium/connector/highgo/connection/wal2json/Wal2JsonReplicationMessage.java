...
class Wal2JsonReplicationMessage implements ReplicationMessage {
    ...
    public Object getValue(
        ...
        final io.debezium.connector.highgo.connection.wal2json.Wal2JsonColumnValue columnValue =
                new io.debezium.connector.highgo.connection.wal2json.Wal2JsonColumnValue(
                        rawValue);
