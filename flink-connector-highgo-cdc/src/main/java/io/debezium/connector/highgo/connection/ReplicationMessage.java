...
public interface ReplicationMessage {
     ...
     * io.debezium.connector.highgo.connection.MessageDecoder}. Enables {@link
     * PostgresStreamingChangeEventSource} to advance LSN forward even in case of such messages.
     */
