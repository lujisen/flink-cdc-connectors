...
public class PgProtoMessageDecoder extends AbstractMessageDecoder {
    ...
    private static final Set<PgProto.Op> SUPPORTED_OPS =
            Collect.unmodifiableSet(PgProto.Op.INSERT, PgProto.Op.UPDATE, PgProto.Op.DELETE, PgProto.Op.BEGIN, PgProto.Op.COMMIT);
    ...
    public void processNotEmptyMessage(
        ...
        try {
            ...
            processor.process(
                    new io.debezium.connector.highgo.connection.pgproto
                            .PgProtoReplicationMessage(message, typeRegistry));
