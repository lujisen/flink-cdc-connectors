...
public class ServerInfo {
    ...
    protected static class ReplicationSlot {
        ...
        private io.debezium.connector.highgo.connection.Lsn latestFlushedLsn;
        private io.debezium.connector.highgo.connection.Lsn restartLsn;
        private Long catalogXmin;

        protected ReplicationSlot(
                boolean active,
                io.debezium.connector.highgo.connection.Lsn latestFlushedLsn,
                io.debezium.connector.highgo.connection.Lsn restartLsn,
                Long catalogXmin) {
            this.active = active;
         ...
         */
        protected io.debezium.connector.highgo.connection.Lsn latestFlushedLsn() {
