...
public class PostgresType {
    ...
    public static final PostgresType UNKNOWN =
            new PostgresType("unknown", -1, Integer.MIN_VALUE, null, null, null, null);
    ...
    private PostgresType(
        ...
        this(
                ...
                oid,
                jdbcId,
                io.debezium.connector.highgo.TypeRegistry.NO_TYPE_MODIFIER,
                typeInfo,
                enumValues,
                parentType,
                elementType);
    ...
    public int getDefaultLength() {
        if (typeInfo == null) {
            return io.debezium.connector.highgo.TypeRegistry.UNKNOWN_LENGTH;
        }
        if (parentType != null) {
            if (modifiers == io.debezium.connector.highgo.TypeRegistry.NO_TYPE_MODIFIER) {
