...
/** The factory to create {@link HighgoOffset}. */
public class HighgoOffsetFactory extends OffsetFactory {
    @Override
    public Offset newOffset(Map<String, String> offset) {
        return new HighgoOffset(offset);
    }
    ...
    public Offset createInitialOffset() {
        return HighgoOffset.INITIAL_OFFSET;
    }

    @Override
    public Offset createNoStoppingOffset() {
        return HighgoOffset.NO_STOPPING_OFFSET;
    }
}
