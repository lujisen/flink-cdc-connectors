...
package com.ververica.cdc.connectors.highgo.source.config;
...
public class HighgoSourceConfigFactory extends JdbcSourceConfigFactory {

    private static final long serialVersionUID = 1L;

    private Duration heartbeatInterval = HEARTBEAT_INTERVAL.defaultValue();

    private static final String JDBC_DRIVER = "com.highgo.jdbc.Driver";
    ...
    /**
     * Creates a new {@link com.ververica.cdc.connectors.highgo.source.config.HighgoSourceConfig}
     * for the given subtask {@code subtaskId}.
     */
    @Override
    public HighgoSourceConfig create(int subtaskId) {
        ...
        props.setProperty("database.server.name", "highgo_cdc_source");
