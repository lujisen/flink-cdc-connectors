...
/** Defines the supported metadata columns for {@link HighgoSQLTableSource}. */
public enum HighgoSQLReadableMetadata {
    ...
    HighgoSQLReadableMetadata(String key, DataType dataType, MetadataConverter converter) {
        this.key = key;
