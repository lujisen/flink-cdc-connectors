...
package com.ververica.cdc.connectors.highgo.table;
...
import com.ververica.cdc.connectors.highgo.utils.OptionUtils;
...
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.CHANGELOG_MODE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.CHUNK_META_GROUP_SIZE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.CONNECTION_POOL_SIZE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.CONNECT_MAX_RETRIES;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.CONNECT_TIMEOUT;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.DECODING_PLUGIN_NAME;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.HEARTBEAT_INTERVAL;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.PG_PORT;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_KEY_COLUMN;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_SIZE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_ENABLED;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SCAN_SNAPSHOT_FETCH_SIZE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SCAN_STARTUP_MODE;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SLOT_NAME;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND;
import static com.ververica.cdc.connectors.highgo.source.config.HighgoSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND;
...
/** Factory for creating configured instance of {@link HighgoSQLTableSource}. */
public class HighgoSQLTableFactory implements DynamicTableSourceFactory {

    private static final String IDENTIFIER = "highgo-cdc";
    ...
    public DynamicTableSource createDynamicTableSource(DynamicTableFactory.Context context) {
        ...
        return new HighgoSQLTableSource(
                physicalSchema,
                port,
                hostname,
                databaseName,
