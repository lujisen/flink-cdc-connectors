...
public final class HighgoValueValidator implements RowDataDebeziumDeserializeSchema.ValueValidator {
    ...
    public HighgoValueValidator(String schema, String table) {
