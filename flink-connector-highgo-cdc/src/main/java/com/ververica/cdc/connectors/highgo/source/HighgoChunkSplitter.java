...
import com.ververica.cdc.connectors.highgo.source.utils.HighgoTypeUtils;
 ...
 */
public class HighgoChunkSplitter implements JdbcSourceChunkSplitter {
    private static final Logger LOG = LoggerFactory.getLogger(HighgoChunkSplitter.class);

    private final JdbcSourceConfig sourceConfig;
    private final HighgoDialect dialect;

    public HighgoChunkSplitter(JdbcSourceConfig sourceConfig, HighgoDialect postgresDialect) {
    ...
    public Object[] queryMinMax(JdbcConnection jdbc, TableId tableId, String columnName)
            throws SQLException {
        return HighgoQueryUtils.queryMinMax(jdbc, tableId, columnName);
    }
    ...
    public Object queryMin(
            ...
            throws SQLException {
        return HighgoQueryUtils.queryMin(jdbc, tableId, columnName, excludedLowerBound);
    }
    ...
    public Object queryNextChunkMax(
            ...
            throws SQLException {
        return HighgoQueryUtils.queryNextChunkMax(
