...
import com.ververica.cdc.connectors.highgo.source.utils.ChunkUtils;
import io.debezium.connector.base.ChangeEventQueue;
import io.debezium.connector.highgo.PostgresConnectorConfig;
import io.debezium.connector.highgo.PostgresErrorHandler;
import io.debezium.connector.highgo.PostgresEventDispatcher;
...
import static io.debezium.connector.highgo.PostgresConnectorConfig.PLUGIN_NAME;
import static io.debezium.connector.highgo.PostgresConnectorConfig.SLOT_NAME;
import static io.debezium.connector.highgo.PostgresConnectorConfig.SNAPSHOT_MODE;
...
/** The context of {@link HighgoScanFetchTask} and {@link HighgoStreamFetchTask}. */
public class HighgoSourceFetchTaskContext extends JdbcSourceFetchTaskContext {

    private static final String CONNECTION_NAME = "highgo-fetch-task-connection";

    private static final Logger LOG = LoggerFactory.getLogger(HighgoSourceFetchTaskContext.class);
    ...
    public HighgoSourceFetchTaskContext(
            JdbcSourceConfig sourceConfig, HighgoDialect dataSourceDialect) {
    ...
    public Offset getStreamOffset(SourceRecord sourceRecord) {
        return HighgoOffset.of(sourceRecord);
    }
