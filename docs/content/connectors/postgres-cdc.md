...
Download [flink-sql-connector-postgres-cdc-2.4.0.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-postgres-cdc/2.4.0/flink-sql-connector-postgres-cdc-2.4.0.jar) and put it under `<FLINK_HOME>/lib/`.
...
import com.ververica.cdc.connectors.postgres.source.HighgoSourceBuilder;
